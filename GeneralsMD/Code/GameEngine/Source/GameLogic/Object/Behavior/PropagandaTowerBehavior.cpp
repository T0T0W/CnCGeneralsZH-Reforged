...
{
	// no UpgradeRequired leaves this NULL, which doScan already allows for
	Bool effectUpgraded = m_upgradeRequired && getObject()->getControllingPlayer()->hasUpgradeComplete( m_upgradeRequired );
