...
- Alt-tabbing out of a fullscreen match and back no longer leaves every building already on the map as a dark shadow with nothing standing in it. Fullscreen starts on the old picture, and coming back from the desktop switched the game over to Direct3D 11 halfway through the match. The new picture only knew about what was built after the switch, so older buildings drew as their shadow alone while a new one beside them looked fine. A match keeps the picture it started with now.
